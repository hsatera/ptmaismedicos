...
def read_excel_file(uploaded_file):
    try:
        # Removido engine=None, pois não é um parâmetro válido.
        # Pandas inferirá o motor correto, ou openpyxl é o padrão para .xlsx.
    ...
    if df is not None:
        ...
        try:
            ...
            if not df_cumulativo_chart.empty:
                ...
                df_chart_reset = df_cumulativo_chart.re
